...
# installed.
TK_PREFIX='/Users/aayushagarwal/Content_Agent/venv'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/aayushagarwal/Content_Agent/venv'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/aayushagarwal/Content_Agent/venv/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/aayushagarwal/Content_Agent/venv/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/aayushagarwal/Content_Agent/venv/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Users/aayushagarwal/Content_Agent/venv/lib/libtkstub8.6.a'
